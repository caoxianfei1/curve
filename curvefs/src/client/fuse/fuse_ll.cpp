...
static FuseClient* Client(void* userdata) {
    return reinterpret_cast<FuseClient*>(userdata);
}

static FuseClient* GetClient(fuse_req_t req) {
    return reinterpret_cast<FuseClient*>(req.userdata);
}
