...
public class CurveFS {
    ...
    private static native int nativeCurveFSSetPermission(long cInstancePtr, String name, String user, String group, String superuser, String supergroup);
    ...
    // init->nativeCurveFSSetPermission->(libcurvefs)curvefs_set_permission->(vfs)setGUid
    public void init(String name, String user, String group, String superuser, String supergroup) {
        nativeCurveFSSetPermission(cInstancePtr, name, user, group, superuser, supergroup);
    }
